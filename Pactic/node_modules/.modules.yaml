...
hoistedDependencies:
  ...
  /jest-cli/29.5.0:
    jest-cli: private
  /jest-config/29.5.0_@types+node@20.1.4:
    jest-config: private
  /jest-diff/29.5.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Sun, 14 May 2023 18:06:38 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  - /fsevents/2.3.2
storeDir: C:\Users\Gun\AppData\Local\pnpm\store\v3
virtualStoreDir: C:\Users\Gun\OneDrive\Documents\GitHub\WebPro\Pactic\node_modules\.pnpm
